"""
Cypher Spectre DeepSight – Security Scanner for Lua / Luau scripts.

Detects malicious or suspicious scripts before and after runtime
deobfuscation performed by the Cypher Spectre engine.

Detects scripts that attempt to:
  • Discover the Cypher Spectre runtime environment  (debug.getinfo, package.path/cpath, /proc/self/*)
...
_PATTERNS: list[_Pattern] = [
    ...
    _Pattern(
        ...
        severity="CRITICAL",
        description=(
            "References /proc/self/* – reveals the Cypher Spectre runtime executable"
